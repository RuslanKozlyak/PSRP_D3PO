...
g_1 = graph_generator.alter_graph( g_1, shift=(15, 15), scale=(100.0, 100.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=0, convert_to_int=True )
g_2 = graph_generator.build_graph( 16, graph_type="ring", layout="kamada-kawai")
g_2 = graph_generator.alter_graph( g_2, shift=(12.5, 12.5), scale=(120.0, 120.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=0, convert_to_int=True )
...
g_4 = graph_generator.alter_graph( g_4, shift=(10, 10), scale=(150.0, 150.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=0, convert_to_int=True )
...
g_4 = graph_generator.alter_graph( g_4, shift=(7.5, 7.5), scale=(200.0, 200.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=90, convert_to_int=True )
...
g_4 = graph_generator.build_graph( 5, graph_type="tree", layout="kamada-kawai")
g_4 = graph_generator.alter_graph( g_4, shift=(16.5, 16.5), scale=(100.0, 100.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=0, convert_to_int=True )
composed_graph = graph_generator.compose_graphs( composed_graph, g_4 )

g_4 = graph_generator.build_graph( 5, graph_type="tree", layout="kamada-kawai")
g_4 = graph_generator.alter_graph( g_4, shift=(13.5, 13.5), scale=(100.0, 100.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=0, convert_to_int=True )
composed_graph = graph_generator.compose_graphs( composed_graph, g_4 )

g_4 = graph_generator.build_graph( 5, graph_type="tree", layout="kamada-kawai")
g_4 = graph_generator.alter_graph( g_4, shift=(16.5, 13.5), scale=(100.0, 100.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=0, convert_to_int=True )
composed_graph = graph_generator.compose_graphs( composed_graph, g_4 )

g_4 = graph_generator.build_graph( 5, graph_type="tree", layout="kamada-kawai")
g_4 = graph_generator.alter_graph( g_4, shift=(13.5, 16.5), scale=(100.0, 100.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=0, convert_to_int=True )
composed_graph = graph_generator.compose_graphs( composed_graph, g_4 )
...
g_4 = graph_generator.build_graph( 10, graph_type="cube", layout="kamada-kawai")
g_4 = graph_generator.alter_graph( g_4, shift=(6.0, 6.0), scale=(250.0, 250.0),
                                   noised_nodes_part=0.2, node_noise_strength=0.05,
                                   rotation_angle=45, convert_to_int=True )
composed_graph = graph_generator.compose_graphs( composed_graph, g_4,
                                                 m_routes=1, k_neighbours=1, routes_strategy="local" )
