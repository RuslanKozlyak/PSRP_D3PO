...
g_2 = graph_generator.alter_graph( g_2, shift=(1.0, 1.0), scale=(130.0, 130.0), rotation_angle=0, convert_to_int=True )
...
g_3 = graph_generator.alter_graph( g_3, shift=(4.0, 1.3), scale=(100.0, 100.0), rotation_angle=45,
                                   convert_to_int=True, random_seed=45)
...
g_3 = graph_generator.alter_graph( g_3, shift=(3.0, 3.0), scale=(100.0, 100.0),
                                   rotation_angle=30, convert_to_int=True)
composed_graph = graph_generator.compose_graphs( composed_graph, g_3, m_routes=4 )
